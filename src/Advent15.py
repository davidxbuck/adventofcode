...
class Creature(object):
    ...
    def attack(self):
        ...
        for ix, creature_ in enumerate(creatures):
            if creature_.species == oppo and creature_.alive and creature_.hit_points > 0:
                ...
                if creature_.coords in self.neighbours:
                    ...
                    # print([creature_.hit_points, creature_.x, creature_.y, ix])
        ...
        print("Attack", attack, self.coords, self.species, "Attacks", creatures[attack[3]].species,
            creatures[attack[3]].coords, creatures[attack[3]].hit_points)
...
def print_creatures(creatures):
    for ii, creaturex in enumerate(creatures):
        print(ii, creaturex.id, creaturex.species, creaturex.coords, creaturex.hit_points, creaturex.alive)
...
def main():
    ...
    while not war_over:
        ...
        for creature in move_order:
            ...
            # Stuck
            # print(creature.coords, creature.neighbours, creature.neighbourcheck)
            ...
            # print(creature, creature.coords, creature.species, targets)
            if len(targets) == 0:
                continue  # Targets all unreachable this move
            chosen = sorted(targets)[0][1:]
            # print(chosen, sorted(targets))
    ...
    print("R*HP", (rounds-2) * hit_points)
